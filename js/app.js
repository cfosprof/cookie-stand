...
let seattle = {
  ...
  generateCookies: function() {
    ...
    for (let i = 0; i < this.hours.length; i++) {
      ...
      let cookiesForHour = customersForHour * this.avgCookieBought;
      ...
      console.log(`${this.hours[i]}: ${this.customersForHour[i]} customers, ${this.cookiesSoldPerHour[i]} cookies`);
    }
    console.log(`Total: ${this.dailySoldTotal} cookies`);
  }
};
...
//       console.log(`${this.hours[i]}: ${cookiesPerHour} customers`);
//     }
//   },
// };
